...
class Client:
    ...
    def process(self, msg=b"-"):
        ...
        if msg == test:
            ...
            new_msg=stbyte+id_cliente1+str(self.public_key_client).encode()#mensagem inicial a enviar para o servidor
        ...
        if msg.startswith(test2):
            ...
            new_msg =iv_c+mac_sig+signature+ct  # mensagem a enviar para o servidor, este necessitara do do salM e do salt2, nos kdfs correspondentes
            ...
            if(mac_sig==mac_serv):
                ...
                new_msg= iv_c+mac_sig+signature+ct
                return new_msg if len(new_msg)>0 else None
                process()
            else:

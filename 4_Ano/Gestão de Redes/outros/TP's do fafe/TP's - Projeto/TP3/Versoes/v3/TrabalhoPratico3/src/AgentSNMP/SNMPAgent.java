...
public class SNMPAgent extends BaseAgent {
     ...
     */
    public void registerManagedObject(Object value) {
        try {
    ...
    public void configurationParameters() throws IOException{
    ...
    public static void main(String[] args) throws IOException {
        SNMPAgent agent = new SNMPAgent("0.0.0.0/35538");

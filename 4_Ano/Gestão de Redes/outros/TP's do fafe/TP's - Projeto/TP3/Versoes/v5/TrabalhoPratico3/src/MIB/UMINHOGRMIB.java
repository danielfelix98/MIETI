...
public class UMINHOGRMIB implements MOGroup {
    ...
    public static final OID oidUnpredictableFirstSeed =
    ...
    private MOScalar<OctetString> unpredictableFirstSeed;
    ...
    protected void createMO(MOFactory moFactory) {
        ...
        unpredictableFirstSeed =
                moFactory.createScalar(oidUnpredictableFirstSeed,
                        moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_ONLY),
                        null,
                        TC_MODULE_SNMPV2_TC, TC_DISPLAYSTRING);
    ...
    public MOScalar<OctetString> getUnpredictableFirstSeed() {
        return unpredictableFirstSeed;
    }
    ...
    public void registerMOs(MOServer server, OctetString context)
        ...
        server.register(this.unpredictableFirstSeed, context);
    ...
    public void unregisterMOs(MOServer server, OctetString context) {
        ...
        server.unregister(this.unpredictableFirstSeed, context);
    ...
    class RandomEntryRowFactory
            implements MOTableRowFactory<RandomEntryRow> {

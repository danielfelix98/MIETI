            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <form method="POST">
                       ...
                       <input type="text" placeholder="FIRST NAME" style="color: black;" size="20" name="frist" required><br>

                        <label style="width: 15%;">Last name</label>
                        <input type="text" placeholder="LAST NAME" style="color: black;" size="20" name="last" required><br>
                        
                        <label style="width: 15%;">Username</label>
                        <input type="text" placeholder="USERNAME" style="color: black;" size="20" name="username" required><br>

                        <label style="width: 15%;">Age</label>
                        <input type="int" placeholder="e.g. 23" style="color: black;" size="20" name="age" required><br>

                        <label style="width: 15%;">Gender</label>
                        <input type="text" placeholder="MALE or FEMALE" style="color: black;" size="20" name="gender" required><br>

                        <label style="width: 15%;">Email</label>
                        <input type="email" placeholder="youremail@gmail.com" style="color: black;" size="20" name="email" required><br>

                        <label style="width: 15%;">Password</label>
                        <input type="password" placeholder="PASSWORD" style="color: black;" size="20" name="password" id="pass" required><br>
                        
                        <label style="width: 15%;">Phone number</label>
                        <input type="int" placeholder="e.g. +351 111 111 111" style="color: black;" size="20" name="phonenumber" id="phonenumber" required><br>
                        
                        <label style="width: 15%;">1º SOS number</label>
                        <input type="int" placeholder="e.g. +351 222 222 222" style="color: black;" size="20" name="1sosnumber" id="1sosnum" required><br>
